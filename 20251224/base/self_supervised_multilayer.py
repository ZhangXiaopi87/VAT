...
class VIMEMultiLayerModel(nn.Module):
    ...
    New encoder architecture (256-128-64):
        Layer 1: input_dim -> 256 (ReLU)
        Layer 2: 256 -> 128 (ReLU)
        Layer 3: 128 -> hidden_dim (64) (ReLU)
    """

    def __init__(self, input_dim: int, hidden_dim: int):
        super().__init__()
        # Multi-layer encoder: 256 -> 128 -> hidden_dim (64)
        ...
        self.layer3 = nn.Sequential(
            nn.Linear(128, hidden_dim), nn.ReLU()  # hidden_dim should be 64
        )

        # Decoders from final layer (hidden_dim) back to input_dim
