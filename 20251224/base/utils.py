"""Utility functions for VAT framework."""
...
def save_training_metrics(
    ...
    Args:
        ...
        model_name: Name of the model (e.g., 'autoencoder_encoder', 'vat_class_model')
        model_state_dict: Model state dictionary
        training_history: Dictionary with training/validation loss/accuracy history
        hyperparameters: Dictionary with all hyperparameters
        final_metrics: Dictionary with final evaluation metrics
        model_info: Dictionary with model architecture information
        metadata: Dictionary with additional metadata (timestamp, dataset info, etc.)
    """
