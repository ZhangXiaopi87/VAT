...
This module is copied from VIME to ensure consistent baseline comparison.
"""
...
class AutoencoderModel(nn.Module):
    """Autoencoder model with 256-128-64 architecture."""

    def __init__(self, input_dim: int, hidden_dim: int):
        super().__init__()
        # New architecture: input_dim -> 256 -> 128 -> hidden_dim (64)
